...
public:
     ...
     */
    VkResult createRenderPass(VkPipelineStageFlagBits srcStageMask = VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT,
                              VkPipelineStageFlagBits dstStageMask = VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT,
                              VkAccessFlagBits srcAccessMask = VK_ACCESS_MEMORY_READ_BIT,
                              VkAccessFlagBits dstAccessMask = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT)
    {
        ...
        framebufferInfo.layers = maxLayers > 0 ? maxLayers : 1;
