...
void VulkanExampleBase::prepare()
{
    ...
    if (settings.overlay) {
        ...
        UIOverlay.shaders = {
            vks::LoadShaders::loadShader(vulkanDevice, "base/uioverlay.vert.spv", VK_SHADER_STAGE_VERTEX_BIT),
            vks::LoadShaders::loadShader(vulkanDevice, "base/uioverlay.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT),
        };
...
void VulkanExampleBase::setupRenderPass()
{
    ...
    vulkanRenderPass.addAttachmentDescriptions(swapChain.colorFormat, VK_IMAGE_LAYOUT_PRESENT_SRC_KHR);
    vulkanRenderPass.addAttachmentDescriptions(depthFormat, VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL);
